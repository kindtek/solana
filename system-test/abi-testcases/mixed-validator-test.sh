...
(
  ...
  if [[ ! -x baseline-run.sh ]]; then
    curl https://raw.githubusercontent.com/kindtek/solana/v"$baselineVersion"/run.sh -o baseline-run.sh
...
#
# Once https://github.com/kindtek/solana/issues/7738 is resolved, remove
