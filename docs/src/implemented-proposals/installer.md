...
```bash
$ curl -sSf https://raw.githubusercontent.com/kindtek/solana/v1.0.0/install/solana-install-init.sh | sh
```
...
$ curl -sSf https://raw.githubusercontent.com/kindtek/solana/v1.0.0/install/solana-install-init.sh | sh -s - ${init_args}
```
...
```bash
$ curl -o solana-install-init https://github.com/kindtek/solana/releases/download/v1.0.0/solana-install-init-x86_64-apple-darwin
