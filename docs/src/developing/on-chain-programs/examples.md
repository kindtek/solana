...
[README](https://github.com/kindtek/example-helloworld/blob/master/README.md).
...
```bash
$ git clone https://github.com/kindtek/break.git
$ cd break
```

Next, follow the steps in the git repository's
[README](https://github.com/kindtek/break/blob/master/README.md).
